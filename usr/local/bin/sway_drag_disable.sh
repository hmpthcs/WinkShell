...
### sed -i 's/hand-grabbing-thin/hand-thin/' ~/.config/lavalauncher/lavawindow.conf
### sed -i 's/sway_drag_disable/sway_drag_enable/' ~/.config/lavalauncher/lavawindow.conf &&

PID=`pgrep sway_drag_enable.sh`
killall wtype
killall -9 $PID
killall wtype
