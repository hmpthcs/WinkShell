...
### = was working with lavalauncher
### sed -i 's/crop-thin/selection-plus-thin/' ~/.config/lavalauncher/lavawindow.conf
### sed -i 's/sway_resize_enable/sway_resize_disable/' ~/.config/lavalauncher/lavawindow.conf
### swaymsg floating_modifier Alt inverse
